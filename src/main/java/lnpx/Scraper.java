...
public class Scraper {
        ...
        private String[] accountToScrape = {"repubblica","Corriere","Agenzia_Ansa","SkyTG24"};

        static Logger log = Logger.getLogger(
                      Scraper.class.getName());
        
        //Funzione per effettuare l'analisi del testo delle parole
        private static void articleTextAnalysis(){
