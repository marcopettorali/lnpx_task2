...
public class MongoDBManager {
     ...
     * @return suggestedArticles Array of suggested articles for the specifi user
     */
     ...
     */
    public static List<String> calculateTrandingKeyWords()
    {
         MongoCollection<Document> collection = database.getCollection("Article");
         ArrayList<String> trandingKeywords=new ArrayList<>();
         AggregateIterable<Document> results;
         results = collection.aggregate(Arrays.asList(
        ...
        for (Document dbObject : results)
        {
            ...
            trandingKeywords.add((String) dbObject.get("_id"));
        }
        return trandingKeywords;
    }
